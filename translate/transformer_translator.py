...
class TransformerTranslator:
    ...
    def __init__(self, model: nn.Module, tokenizer_encoder: AutoTokenizer, tokenizer_decoder: AutoTokenizer, max_length: int = 100, device: str = 'cpu') -> None:
        ...
        Args:
            ...
            device (str, optional): Accelerator type. Default 'cpu'.
        """
        self.model = model
    ...
    def __call__(self, src_sentence: str) -> str:
        ...
        """
        src_indexes = self.tokenizer_encoder(src_sentence, return_tensors='pt', add_special_tokens=True,
                                        max_length=self.max_length, padding='max_length',
                                        truncation=True).to(self.device).data["input_ids"]
        ...
        for i in range(self.max_length):
            ...
            if trg_tokens[-1] == '[SEP]':
                break
        res_sent = self.tokenizer_decoder.convert_tokens_to_string(trg_tokens[1:-1])
        return res_sent